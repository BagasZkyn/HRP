...
function OnPlayerDataLoaded(playerid, race_check)
{
	...
	{		
		...
		if(pData[playerid][pPassword] > 10)
		{
			...
			ShowPlayerDialog(playerid, DIALOG_LOGIN, DIALOG_STYLE_PASSWORD, "Login to Soul Side", lstring, "Login", "Quit");
		}
...
function AssignPlayerData(playerid)
{
    ...
    cache_get_value_name_int(0, "pingsan", pData[playerid][pPingsan]);
    cache_get_value_name_int(0, "waktupingsan", pData[playerid][pWaktuPingsan]);
