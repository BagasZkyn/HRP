...
new PlayerText:HBESS[MAX_PLAYERS][11];
new PlayerText:BARMAKAN[MAX_PLAYERS];
new PlayerText:BARMINUM[MAX_PLAYERS];
new PlayerText:TEXTMAKAN[MAX_PLAYERS];
new PlayerText:TEXTMINUM[MAX_PLAYERS];
new PlayerText:IDPLAYER[MAX_PLAYERS];
new PlayerText:UANGPLAYER[MAX_PLAYERS];
new PlayerText:PEMBATAS[MAX_PLAYERS];
new PlayerText:MESINCAR[MAX_PLAYERS];
new PlayerText:BENSINCAR[MAX_PLAYERS];
new PlayerText:KECEPATANCAR[MAX_PLAYERS];
new PlayerText:NAMACAR[MAX_PLAYERS];
//Info textdraw
new PlayerText:InfoTD[MAX_PLAYERS];
new Text:TextTime, Text:TextDate;

new PlayerText:HBEVEH[MAX_PLAYERS][4];
new PlayerText:SPEEDVEH[MAX_PLAYERS];
new PlayerText:NAMEVEH[MAX_PLAYERS];
new PlayerText:HEALVEH[MAX_PLAYERS];
...
{
	//HBEVEH
	HBEVEH[playerid][0] = CreatePlayerTextDraw(playerid, 113.000000, 364.000000, "ld_pool:ball");
	PlayerTextDrawFont(playerid, HBEVEH[playerid][0], 4);
	PlayerTextDrawLetterSize(playerid, HBEVEH[playerid][0], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBEVEH[playerid][0], 27.000000, 32.500000);
	PlayerTextDrawSetOutline(playerid, HBEVEH[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, HBEVEH[playerid][0], 0);
	PlayerTextDrawAlignment(playerid, HBEVEH[playerid][0], 1);
	PlayerTextDrawColor(playerid, HBEVEH[playerid][0], 1296911871);
	PlayerTextDrawBackgroundColor(playerid, HBEVEH[playerid][0], 255);
	PlayerTextDrawBoxColor(playerid, HBEVEH[playerid][0], 50);
	PlayerTextDrawUseBox(playerid, HBEVEH[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, HBEVEH[playerid][0], 1);
	PlayerTextDrawSetSelectable(playerid, HBEVEH[playerid][0], 0);

	HBEVEH[playerid][1] = CreatePlayerTextDraw(playerid, 116.000000, 376.000000, "mp/h");
	PlayerTextDrawFont(playerid, HBEVEH[playerid][1], 1);
	PlayerTextDrawLetterSize(playerid, HBEVEH[playerid][1], 0.250000, 1.350000);
	PlayerTextDrawTextSize(playerid, HBEVEH[playerid][1], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, HBEVEH[playerid][1], 0);
	PlayerTextDrawSetShadow(playerid, HBEVEH[playerid][1], 0);
	PlayerTextDrawAlignment(playerid, HBEVEH[playerid][1], 1);
	PlayerTextDrawColor(playerid, HBEVEH[playerid][1], 16777215);
	PlayerTextDrawBackgroundColor(playerid, HBEVEH[playerid][1], 255);
	PlayerTextDrawBoxColor(playerid, HBEVEH[playerid][1], 50);
	PlayerTextDrawUseBox(playerid, HBEVEH[playerid][1], 0);
	PlayerTextDrawSetProportional(playerid, HBEVEH[playerid][1], 1);
	PlayerTextDrawSetSelectable(playerid, HBEVEH[playerid][1], 0);

	SPEEDVEH[playerid] = CreatePlayerTextDraw(playerid, 118.000000, 367.000000, "500");
	PlayerTextDrawFont(playerid, SPEEDVEH[playerid], 1);
	PlayerTextDrawLetterSize(playerid, SPEEDVEH[playerid], 0.250000, 1.350000);
	PlayerTextDrawTextSize(playerid, SPEEDVEH[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, SPEEDVEH[playerid], 0);
	PlayerTextDrawSetShadow(playerid, SPEEDVEH[playerid], 0);
	PlayerTextDrawAlignment(playerid, SPEEDVEH[playerid], 1);
	PlayerTextDrawColor(playerid, SPEEDVEH[playerid], -3841);
	PlayerTextDrawBackgroundColor(playerid, SPEEDVEH[playerid], 255);
	PlayerTextDrawBoxColor(playerid, SPEEDVEH[playerid], 50);
	PlayerTextDrawUseBox(playerid, SPEEDVEH[playerid], 0);
	PlayerTextDrawSetProportional(playerid, SPEEDVEH[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, SPEEDVEH[playerid], 0);

	NAMEVEH[playerid] = CreatePlayerTextDraw(playerid, 109.000000, 349.000000, "Sultan");
	PlayerTextDrawFont(playerid, NAMEVEH[playerid], 1);
	PlayerTextDrawLetterSize(playerid, NAMEVEH[playerid], 0.250000, 1.350000);
	PlayerTextDrawTextSize(playerid, NAMEVEH[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, NAMEVEH[playerid], 1);
	PlayerTextDrawSetShadow(playerid, NAMEVEH[playerid], 0);
	PlayerTextDrawAlignment(playerid, NAMEVEH[playerid], 1);
	PlayerTextDrawColor(playerid, NAMEVEH[playerid], 16777215);
	PlayerTextDrawBackgroundColor(playerid, NAMEVEH[playerid], 255);
	PlayerTextDrawBoxColor(playerid, NAMEVEH[playerid], 50);
	PlayerTextDrawUseBox(playerid, NAMEVEH[playerid], 0);
	PlayerTextDrawSetProportional(playerid, NAMEVEH[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, NAMEVEH[playerid], 0);

	HBEVEH[playerid][2] = CreatePlayerTextDraw(playerid, 142.000000, 365.000000, "Health:");
	PlayerTextDrawFont(playerid, HBEVEH[playerid][2], 1);
	PlayerTextDrawLetterSize(playerid, HBEVEH[playerid][2], 0.250000, 1.350000);
	PlayerTextDrawTextSize(playerid, HBEVEH[playerid][2], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, HBEVEH[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, HBEVEH[playerid][2], 0);
	PlayerTextDrawAlignment(playerid, HBEVEH[playerid][2], 1);
	PlayerTextDrawColor(playerid, HBEVEH[playerid][2], -16776961);
	PlayerTextDrawBackgroundColor(playerid, HBEVEH[playerid][2], 255);
	PlayerTextDrawBoxColor(playerid, HBEVEH[playerid][2], 50);
	PlayerTextDrawUseBox(playerid, HBEVEH[playerid][2], 0);
	PlayerTextDrawSetProportional(playerid, HBEVEH[playerid][2], 1);
	PlayerTextDrawSetSelectable(playerid, HBEVEH[playerid][2], 0);

	HEALVEH[playerid] = CreatePlayerTextDraw(playerid, 174.000000, 365.000000, "1000");
	PlayerTextDrawFont(playerid, HEALVEH[playerid], 1);
	PlayerTextDrawLetterSize(playerid, HEALVEH[playerid], 0.254166, 1.450000);
	PlayerTextDrawTextSize(playerid, HEALVEH[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, HEALVEH[playerid], 1);
	PlayerTextDrawSetShadow(playerid, HEALVEH[playerid], 0);
	PlayerTextDrawAlignment(playerid, HEALVEH[playerid], 1);
	PlayerTextDrawColor(playerid, HEALVEH[playerid], 16777215);
	PlayerTextDrawBackgroundColor(playerid, HEALVEH[playerid], 255);
	PlayerTextDrawBoxColor(playerid, HEALVEH[playerid], 50);
	PlayerTextDrawUseBox(playerid, HEALVEH[playerid], 0);
	PlayerTextDrawSetProportional(playerid, HEALVEH[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, HEALVEH[playerid], 0);

	HBEVEH[playerid][3] = CreatePlayerTextDraw(playerid, 141.000000, 378.000000, "Fuel:");
	PlayerTextDrawFont(playerid, HBEVEH[playerid][3], 1);
	PlayerTextDrawLetterSize(playerid, HBEVEH[playerid][3], 0.287499, 1.450000);
	PlayerTextDrawTextSize(playerid, HBEVEH[playerid][3], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, HBEVEH[playerid][3], 1);
	PlayerTextDrawSetShadow(playerid, HBEVEH[playerid][3], 0);
	PlayerTextDrawAlignment(playerid, HBEVEH[playerid][3], 1);
	PlayerTextDrawColor(playerid, HBEVEH[playerid][3], -65281);
	PlayerTextDrawBackgroundColor(playerid, HBEVEH[playerid][3], 255);
	PlayerTextDrawBoxColor(playerid, HBEVEH[playerid][3], 50);
	PlayerTextDrawUseBox(playerid, HBEVEH[playerid][3], 0);
	PlayerTextDrawSetProportional(playerid, HBEVEH[playerid][3], 1);
	PlayerTextDrawSetSelectable(playerid, HBEVEH[playerid][3], 0);

	FUELVEH[playerid] = CreatePlayerTextDraw(playerid, 166.000000, 379.000000, "1000");
	PlayerTextDrawFont(playerid, FUELVEH[playerid], 1);
	PlayerTextDrawLetterSize(playerid, FUELVEH[playerid], 0.254166, 1.450000);
	PlayerTextDrawTextSize(playerid, FUELVEH[playerid], 400.000000, 17.000000);
	...
	PlayerTextDrawColor(playerid, FUELVEH[playerid], 16777215);
	PlayerTextDrawBackgroundColor(playerid, FUELVEH[playerid], 255);
	PlayerTextDrawBoxColor(playerid, FUELVEH[playerid], 50);
	PlayerTextDrawUseBox(playerid, FUELVEH[playerid], 0);
	PlayerTextDrawSetProportional(playerid, FUELVEH[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, FUELVEH[playerid], 0);
	//HBE
	HBESS[playerid][0] = CreatePlayerTextDraw(playerid, 581.000000, 375.000000, "_");
	PlayerTextDrawFont(playerid, HBESS[playerid][0], 1);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][0], 0.612500, 7.700002);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][0], 302.000000, 115.000000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][0], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][0], 2);
	PlayerTextDrawColor(playerid, HBESS[playerid][0], -1);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][0], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][0], 207);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][0], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][0], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][0], 1);

	HBESS[playerid][1] = CreatePlayerTextDraw(playerid, 546.000000, 398.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, HBESS[playerid][1], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][1], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][1], 85.000000, 13.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][1], 1);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][1], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][1], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][1], 1296911871);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][1], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][1], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][1], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][1], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][1], 0);

	HBESS[playerid][2] = CreatePlayerTextDraw(playerid, 546.000000, 420.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, HBESS[playerid][2], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][2], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][2], 85.000000, 13.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][2], 1);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][2], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][2], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][2], 1296911871);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][2], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][2], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][2], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][2], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][2], 0);

	BARMAKAN[playerid] = CreatePlayerTextDraw(playerid, 547.000000, 399.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, BARMAKAN[playerid], 4);
	PlayerTextDrawLetterSize(playerid, BARMAKAN[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, BARMAKAN[playerid], 82.500000, 11.000000);
	...
	PlayerTextDrawColor(playerid, BARMAKAN[playerid], 852308735);
	...
	BARMINUM[playerid] = CreatePlayerTextDraw(playerid, 547.000000, 421.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, BARMINUM[playerid], 4);
	PlayerTextDrawLetterSize(playerid, BARMINUM[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, BARMINUM[playerid], 82.500000, 11.000000);
	...
	HBESS[playerid][3] = CreatePlayerTextDraw(playerid, 528.000000, 398.000000, "HUD:radar_pizza");
	PlayerTextDrawFont(playerid, HBESS[playerid][3], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][3], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][3], 13.000000, 12.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][3], 0);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][3], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][3], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][3], -3841);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][3], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][3], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][3], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][3], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][3], 0);

	HBESS[playerid][4] = CreatePlayerTextDraw(playerid, 530.000000, 421.000000, "HUD:radar_diner");
	PlayerTextDrawFont(playerid, HBESS[playerid][4], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][4], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][4], 13.000000, 13.000000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][4], 0);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][4], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][4], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][4], -3841);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][4], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][4], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][4], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][4], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][4], 0);

	TEXTMAKAN[playerid] = CreatePlayerTextDraw(playerid, 577.000000, 399.000000, "100");
	PlayerTextDrawFont(playerid, TEXTMAKAN[playerid], 1);
	PlayerTextDrawLetterSize(playerid, TEXTMAKAN[playerid], 0.237498, 1.200000);
	PlayerTextDrawTextSize(playerid, TEXTMAKAN[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, TEXTMAKAN[playerid], 0);
	PlayerTextDrawSetShadow(playerid, TEXTMAKAN[playerid], 0);
	PlayerTextDrawAlignment(playerid, TEXTMAKAN[playerid], 1);
	PlayerTextDrawColor(playerid, TEXTMAKAN[playerid], -1);
	PlayerTextDrawBackgroundColor(playerid, TEXTMAKAN[playerid], 255);
	PlayerTextDrawBoxColor(playerid, TEXTMAKAN[playerid], 50);
	PlayerTextDrawUseBox(playerid, TEXTMAKAN[playerid], 0);
	PlayerTextDrawSetProportional(playerid, TEXTMAKAN[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, TEXTMAKAN[playerid], 0);

	TEXTMINUM[playerid] = CreatePlayerTextDraw(playerid, 577.000000, 421.000000, "100");
	PlayerTextDrawFont(playerid, TEXTMINUM[playerid], 1);
	PlayerTextDrawLetterSize(playerid, TEXTMINUM[playerid], 0.237498, 1.200000);
	PlayerTextDrawTextSize(playerid, TEXTMINUM[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, TEXTMINUM[playerid], 0);
	PlayerTextDrawSetShadow(playerid, TEXTMINUM[playerid], 0);
	PlayerTextDrawAlignment(playerid, TEXTMINUM[playerid], 1);
	PlayerTextDrawColor(playerid, TEXTMINUM[playerid], -1);
	PlayerTextDrawBackgroundColor(playerid, TEXTMINUM[playerid], 255);
	PlayerTextDrawBoxColor(playerid, TEXTMINUM[playerid], 50);
	PlayerTextDrawUseBox(playerid, TEXTMINUM[playerid], 0);
	PlayerTextDrawSetProportional(playerid, TEXTMINUM[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, TEXTMINUM[playerid], 0);

	IDPLAYER[playerid] = CreatePlayerTextDraw(playerid, 523.000000, 436.000000, "ID:100");
	PlayerTextDrawFont(playerid, IDPLAYER[playerid], 1);
	PlayerTextDrawLetterSize(playerid, IDPLAYER[playerid], 0.179166, 1.149999);
	PlayerTextDrawTextSize(playerid, IDPLAYER[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, IDPLAYER[playerid], 0);
	...
	UANGPLAYER[playerid] = CreatePlayerTextDraw(playerid, 525.000000, 377.000000, "~g~$00000000");
	PlayerTextDrawFont(playerid, UANGPLAYER[playerid], 3);
	PlayerTextDrawLetterSize(playerid, UANGPLAYER[playerid], 0.245830, 0.899999);
	PlayerTextDrawTextSize(playerid, UANGPLAYER[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, UANGPLAYER[playerid], 0);
	PlayerTextDrawSetShadow(playerid, UANGPLAYER[playerid], 0);
	PlayerTextDrawAlignment(playerid, UANGPLAYER[playerid], 1);
	PlayerTextDrawColor(playerid, UANGPLAYER[playerid], 1097458175);
	PlayerTextDrawBackgroundColor(playerid, UANGPLAYER[playerid], 255);
	PlayerTextDrawBoxColor(playerid, UANGPLAYER[playerid], 50);
	PlayerTextDrawUseBox(playerid, UANGPLAYER[playerid], 0);
	PlayerTextDrawSetProportional(playerid, UANGPLAYER[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, UANGPLAYER[playerid], 0);

	PEMBATAS[playerid] = CreatePlayerTextDraw(playerid, 519.000000, 369.000000, "ld_chat:badchat");
	PlayerTextDrawFont(playerid, PEMBATAS[playerid], 4);
	PlayerTextDrawLetterSize(playerid, PEMBATAS[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, PEMBATAS[playerid], -15.000000, 13.000000);
	PlayerTextDrawSetOutline(playerid, PEMBATAS[playerid], 1);
	PlayerTextDrawSetShadow(playerid, PEMBATAS[playerid], 0);
	PlayerTextDrawAlignment(playerid, PEMBATAS[playerid], 1);
	PlayerTextDrawColor(playerid, PEMBATAS[playerid], -1);
	PlayerTextDrawBackgroundColor(playerid, PEMBATAS[playerid], 255);
	PlayerTextDrawBoxColor(playerid, PEMBATAS[playerid], 50);
	PlayerTextDrawUseBox(playerid, PEMBATAS[playerid], 1);
	PlayerTextDrawSetProportional(playerid, PEMBATAS[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, PEMBATAS[playerid], 0);

	HBESS[playerid][5] = CreatePlayerTextDraw(playerid, 151.000000, 400.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, HBESS[playerid][5], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][5], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][5], 19.500000, -83.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][5], 1);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][5], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][5], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][5], 1296911871);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][5], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][5], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][5], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][5], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][5], 0);

	MESINCAR[playerid] = CreatePlayerTextDraw(playerid, 153.000000, 399.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, MESINCAR[playerid], 4);
	PlayerTextDrawLetterSize(playerid, MESINCAR[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, MESINCAR[playerid], 15.500000, -80.500000);
	PlayerTextDrawSetOutline(playerid, MESINCAR[playerid], 1);
	PlayerTextDrawSetShadow(playerid, MESINCAR[playerid], 0);
	PlayerTextDrawAlignment(playerid, MESINCAR[playerid], 1);
	PlayerTextDrawColor(playerid, MESINCAR[playerid], -16776961);
	PlayerTextDrawBackgroundColor(playerid, MESINCAR[playerid], 255);
	PlayerTextDrawBoxColor(playerid, MESINCAR[playerid], 50);
	PlayerTextDrawUseBox(playerid, MESINCAR[playerid], 1);
	PlayerTextDrawSetProportional(playerid, MESINCAR[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, MESINCAR[playerid], 0);

	HBESS[playerid][6] = CreatePlayerTextDraw(playerid, 155.000000, 385.000000, "HUD:radar_modgarage");
	PlayerTextDrawFont(playerid, HBESS[playerid][6], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][6], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][6], 11.000000, 11.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][6], 0);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][6], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][6], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][6], -3841);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][6], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][6], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][6], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][6], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][6], 0);

	HBESS[playerid][7] = CreatePlayerTextDraw(playerid, 174.000000, 400.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, HBESS[playerid][7], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][7], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][7], 19.500000, -84.000000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][7], 1);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][7], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][7], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][7], 1296911871);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][7], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][7], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][7], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][7], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][7], 0);

	BENSINCAR[playerid] = CreatePlayerTextDraw(playerid, 176.000000, 399.000000, "ld_dual:white");
	PlayerTextDrawFont(playerid, BENSINCAR[playerid], 4);
	PlayerTextDrawLetterSize(playerid, BENSINCAR[playerid], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, BENSINCAR[playerid], 15.500000, -80.500000);
	PlayerTextDrawSetOutline(playerid, BENSINCAR[playerid], 1);
	PlayerTextDrawSetShadow(playerid, BENSINCAR[playerid], 0);
	PlayerTextDrawAlignment(playerid, BENSINCAR[playerid], 1);
	PlayerTextDrawColor(playerid, BENSINCAR[playerid], -3841);
	PlayerTextDrawBackgroundColor(playerid, BENSINCAR[playerid], 255);
	PlayerTextDrawBoxColor(playerid, BENSINCAR[playerid], 50);
	PlayerTextDrawUseBox(playerid, BENSINCAR[playerid], 1);
	PlayerTextDrawSetProportional(playerid, BENSINCAR[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, BENSINCAR[playerid], 0);

	HBESS[playerid][8] = CreatePlayerTextDraw(playerid, 178.000000, 385.000000, "HUD:radar_centre");
	PlayerTextDrawFont(playerid, HBESS[playerid][8], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][8], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][8], 11.500000, 11.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][8], 0);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][8], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][8], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][8], -3841);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][8], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][8], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][8], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][8], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][8], 0);

	HBESS[playerid][9] = CreatePlayerTextDraw(playerid, 120.000000, 373.000000, "ld_pool:ball");
	PlayerTextDrawFont(playerid, HBESS[playerid][9], 4);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][9], 0.600000, 2.000000);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][9], 26.000000, 29.500000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][9], 1);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][9], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][9], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][9], 1296911871);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][9], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][9], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][9], 1);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][9], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][9], 0);

	KECEPATANCAR[playerid] = CreatePlayerTextDraw(playerid, 125.000000, 378.000000, "500");
	PlayerTextDrawFont(playerid, KECEPATANCAR[playerid], 1);
	PlayerTextDrawLetterSize(playerid, KECEPATANCAR[playerid], 0.216665, 0.949999);
	PlayerTextDrawTextSize(playerid, KECEPATANCAR[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, KECEPATANCAR[playerid], 0);
	PlayerTextDrawSetShadow(playerid, KECEPATANCAR[playerid], 0);
	PlayerTextDrawAlignment(playerid, KECEPATANCAR[playerid], 1);
	PlayerTextDrawColor(playerid, KECEPATANCAR[playerid], -3841);
	PlayerTextDrawBackgroundColor(playerid, KECEPATANCAR[playerid], 255);
	PlayerTextDrawBoxColor(playerid, KECEPATANCAR[playerid], 50);
	PlayerTextDrawUseBox(playerid, KECEPATANCAR[playerid], 0);
	PlayerTextDrawSetProportional(playerid, KECEPATANCAR[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, KECEPATANCAR[playerid], 0);

	NAMACAR[playerid] = CreatePlayerTextDraw(playerid, 110.000000, 347.000000, "Sultan");
	PlayerTextDrawFont(playerid, NAMACAR[playerid], 1);
	PlayerTextDrawLetterSize(playerid, NAMACAR[playerid], 0.362498, 2.149998);
	PlayerTextDrawTextSize(playerid, NAMACAR[playerid], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, NAMACAR[playerid], 1);
	PlayerTextDrawSetShadow(playerid, NAMACAR[playerid], 0);
	PlayerTextDrawAlignment(playerid, NAMACAR[playerid], 1);
	PlayerTextDrawColor(playerid, NAMACAR[playerid], 16777215);
	PlayerTextDrawBackgroundColor(playerid, NAMACAR[playerid], 255);
	PlayerTextDrawBoxColor(playerid, NAMACAR[playerid], 50);
	PlayerTextDrawUseBox(playerid, NAMACAR[playerid], 0);
	PlayerTextDrawSetProportional(playerid, NAMACAR[playerid], 1);
	PlayerTextDrawSetSelectable(playerid, NAMACAR[playerid], 0);

	HBESS[playerid][10] = CreatePlayerTextDraw(playerid, 124.000000, 387.000000, "mp/h");
	PlayerTextDrawFont(playerid, HBESS[playerid][10], 1);
	PlayerTextDrawLetterSize(playerid, HBESS[playerid][10], 0.224999, 1.049999);
	PlayerTextDrawTextSize(playerid, HBESS[playerid][10], 400.000000, 17.000000);
	PlayerTextDrawSetOutline(playerid, HBESS[playerid][10], 0);
	PlayerTextDrawSetShadow(playerid, HBESS[playerid][10], 0);
	PlayerTextDrawAlignment(playerid, HBESS[playerid][10], 1);
	PlayerTextDrawColor(playerid, HBESS[playerid][10], -3841);
	PlayerTextDrawBackgroundColor(playerid, HBESS[playerid][10], 255);
	PlayerTextDrawBoxColor(playerid, HBESS[playerid][10], 50);
	PlayerTextDrawUseBox(playerid, HBESS[playerid][10], 0);
	PlayerTextDrawSetProportional(playerid, HBESS[playerid][10], 1);
	PlayerTextDrawSetSelectable(playerid, HBESS[playerid][10], 0);
	//Info textdraw
...
CreateTextDraw()
{
	...
	//Server Name
	ServerName = TextDrawCreate(490.000000, 8.000038, "Home ~w~Roleplay");
...
//------------[ Phone Textdraws IndoSoul Side ]
	...
	WelcomeTD[4] = TextDrawCreate(255.000000, 400.000000, "Home Roleplay");
