...
public DCC_DM_EMBED(str[], pin, id[])
{
	...
	new DCC_Embed:embed = DCC_CreateEmbed(.title="Soul Side Roleplay", .image_url="https://cdn.discordapp.com/attachments/1379834147001995391/1379916272342667264/Screenshot_20250605_030545_WhatsApp.png?ex=6841faac&is=6840a92c&hm=1986314a87b11fdaed24214f81ef42550f8624ab79fec0fa585fcdfee8969eb9&");
...
public CheckDiscordUCP(DiscordID[], Nama_UCP[])
{
	...
	{
		guild = DCC_FindGuildById("1379523776437424139"); //GANTI INI
		WARGA = DCC_FindRoleById("1379523776437424143"); //GANTI INI
...
{
	new id[21];
    if(channel != DCC_FindChannelById("1379523777125417080")) //GANTI INI
		return 1;
    if(isnull(params)) 
