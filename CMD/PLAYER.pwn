...
CMD:credits(playerid)
{
	...
	"GREEN_E"Terima kasih telah bergabung dengan kami! Copyright © 2021 | Great Roleplay.", pData[playerid][pName]);
...
CMD:death(playerid, params[])
{
    ...
    new kont = GetPVarInt(playerid, "GiveUptime");
    if(kont < gettime()) return Error(playerid, "Tunggu dulu");
